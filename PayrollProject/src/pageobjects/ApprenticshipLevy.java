...
@Page( title="Apprenticship Levy"                                
     , summary=""
     , relativeUrl=""
     , connection="Admin"
     )             
public class ApprenticshipLevy {
...
@PageRow()
	public static class DoNotTouchPayrollReport {
		...
		public WebElement estmtdLevyAlwnceAprnmentThisPeriod;
		
		@FindBy(xpath = ".//td[3]//div[@class='wave-table-cell-text']")
		public WebElement aprntshipLevyPayBill;
		
		@FindBy(xpath = ".//td[4]//div[@class='wave-table-cell-text']")
		public WebElement aprntshipLevyPayGross;
		
		@FindBy(xpath = ".//td[5]//div[@class='wave-table-cell-text']")
		public WebElement aprntshipLevyThisPeriod;
		
		@FindBy(xpath = ".//td[6]//div[@class='wave-table-cell-text']")
		public WebElement totalHMRCPymtsWithLevy;
